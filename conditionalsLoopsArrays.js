...
const enemyAttackType = elements[Math.floor(Math.random()*elements.length)]; //(Random = (0,1) * 3)  ==> Round this down! =====> this number is 
//our index number of elements array
...
let averageStrLen = total / roster.length;
